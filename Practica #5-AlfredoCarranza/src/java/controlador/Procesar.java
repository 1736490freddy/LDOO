...
public class Procesar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(nombre.equals("") || apellidos.equals("") || edad.equals("") || correo.equals("") || pass.equals("") || anio.equals("") || mes.equals("")|| dia.equals("")){
            request.getRequestDispatcher("DatosIncorrectos.jsp").forward(request, response);
         }
        else{
            Persona per = new Persona(nombre, apellidos, edad, correo, pass, anio, mes,dia);
